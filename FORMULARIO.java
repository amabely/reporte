...
public class FORMULARIO {
    public static void main(String[] args) {
        ...
        System.out.println("Proporcionar elementos para la elaboración de Protocolos para la prevención, detección y actuación en ");
        System.out.println("casos de abuso sexual, acoso escolar y maltrato en nuestra escuela, con la finalidad de salvaguardar la ");
        ...
        System.out.println("Se comunicara por escrito y digital a su autoridad inmediata superior sobre la denuncia o detección realizada");
